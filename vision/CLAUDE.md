...
| File | Audience | Notes |
|---|---|---|
| `clients.html` | Series A–C founders/CPOs | Growth Lab flagship pitch; the candidate to swap into enchant.co's index when Paul + Brittany pick the winner |
